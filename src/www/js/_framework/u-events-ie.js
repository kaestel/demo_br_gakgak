...
//	u.bug("handle event:" + (element.id ? element.id : element.className) + ":" + window.event.type)
...
//				u.bug("action:" + element.ie_event_action.name)
